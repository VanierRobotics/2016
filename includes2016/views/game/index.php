...
<map name="gamemap" id="gamemap">
    <area id="myBtn" alt="<?=$name?>" title="<?=$name?>" shape="poly" coords="727,478,726,477,725,475,725,473,726,472,728,470,731,469,740,472,787,489,790,494,789,497,788,499,786,501,784,501,713,512,655,521,650,520,640,520,601,502,588,499,587,498"/>
</map>
...
<script type="text/javascript">
    ...
    $('#myBtn').bind("click",function(){
        $('#content').load( "<?=URL.$this->language.$game?>" );
    });
</script>