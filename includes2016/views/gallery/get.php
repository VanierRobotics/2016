...
if(isset($_REQUEST["index"])) {
    ...
    $query = $db->prepare("SELECT gal_img, gal_desc$lang FROM gallery WHERE gal_id IN (:index1, :index2, :index3, :index4) ORDER BY FIELD(gal_id,:o1,:o2,:o3,:o4)");
