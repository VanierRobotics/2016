...
<div id="canvas" class="container-fluid">
    <div id="book-zoom">
        <div class="sj-book">
            ...
            <?php
                //$pages = 10; //REPLACE WITH FOREACH BASED ON SHIT FROM CONTROLLER
				...
				foreach($robot_book as $key => $book_txt)
				{
					...
					*/
                    ...
                    echo('<div class="table-contents">'
                           .  	'<h1>Contents</h1>'
                           .   		'<ul>'
						   .      		'<li><a href="#page/7">EDDY STUFF <span>7</span></a></li>'
						   .      		'<li><a href="#page/8">Youth<span>10</span></a></li>'
						   .      		'<li><a href="#page/9">The Apple I <span>18</span></a></li>'
						   .      		'<li><a href="#page/10">Apple\'s early days <span>25</span></a></li>'
