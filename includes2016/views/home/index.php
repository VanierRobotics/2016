...
<map id="mymap" name="mymap">
    <area shape="poly" alt="Build Bios" title="Build Bios" coords="709,317,838,314,833,599,768,536,700,590,708,318"
          href="<?= $link . $bios_build ?>" target=""/>

    <area shape="poly" alt="Web Bios" title="Web Bios"
          coords="1344,319,1195,315,1195,318,1186,320,1195,603,1263,542,1332,599,1325,325,1345,324,1345,319"
          href="<?= $link . $bios_web ?>" target=""/>
    <area shape="poly" alt="Video Bios" title="Video Bios" coords="1668,0,1708,523,1574,413,1452,533,1411,-1"
          href="<?= $link . $bios_video ?>" target=""/>
    <area shape="poly" alt="Kiosk Bios" title="Kiosk Bios" coords="569,533,457,410,336,512,375,-3,610,-1,571,498"
          href="<?= $link . $bios_kiosk ?>" target=""/>

    <area shape="poly" alt="Journalism" title="Journalism"
          ...
          href="<?= $link . $journalism ?>" target=""/>
    <area shape="poly" alt="Competition" title="Competition"
          ...
          href="<?= $link . 'competition' ?>" target=""/>
    <area shape="poly" alt="Robot" title="Robot"
          ...
          href="<?= $link . 'robot' ?>" target=""/>
    <area shape="poly" alt="Gallery" title="Gallery"
          ...
          href="<?= $link . $gallery ?>" target=""/>

    <area shape="poly" alt="Tutorial" title="Tutorial"
          coords="1011,313,1008,315,1007,317,1007,320,1008,322,1005,324,991,330,973,359,961,400,960,424,955,479,1071,478,1063,400,1049,353,1041,342,1029,328,1015,322,1016,321,1017,319,1017,317,1015,316,1012,314,1011,314"
          href="<?= $link . $tuto ?>" target=""/>
    <area shape="poly" alt="Vanier" title="Vanier"
